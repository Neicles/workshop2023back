...
import com.example.workplace2023Backend.Class.*;
...
public class MainController {
    ...
    public ResponseEntity<List<Categorie>> recupererTousLesCat() {
        ...
        return ResponseEntity.ok(categories); // Réponse HTTP 200 avec les utilisateurs en JSON
    }
    @GetMapping("/allCompetence")
    public ResponseEntity<List<Competence>> recupererTousLesCompetences() {
        ...
        return ResponseEntity.ok(competences); // Réponse HTTP 200 avec les utilisateurs en JSON
    }
    @GetMapping(path="/all")
